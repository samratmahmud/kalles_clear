      ...
      <section>
         <div className="container">
            <div className="relative mb-8 md:mb-12 lg:mb-20 xl:mb-32 2xl:mb-44 max-w-[1700px] mx-auto">
               <div className="sticky top-28 z-10 mb-16 sm:mb-20 md:mb-28 lg:mb-36 xl:mb-44 2xl:mb-52">
                  <div className="backdrop-blur-md flex justify-center rounded-3xl bg-black/65 w-full md:w-auto">
