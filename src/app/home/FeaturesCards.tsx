...
const cardsGroup = [
  ...
  },
  {
    ...
    classNames:
      "col-span-12 bg-gray-800 rounded-2xl h-full pb-28 w-1/2 mx-auto",
  },
  {
    title: "Quickview",
    thumbnail: "/images/4.png",
    describtiton: (
      <>Allow shoppers to view product info right on home or collection pages</>
    ),
    className: "bottom-8 left-0 right-0 text-center",
  ...
  },
  {
    ...
    describtiton: (
      <>
        Make shopping experience more fun & informative with Compare & Wishlist
      </>
    ),
  ...
  },
  {
    ...
    className: "bottom-0 left-0 right-0 text-center",
    classNames: "col-span-6 absolute -top-[24%]",
  },
];
