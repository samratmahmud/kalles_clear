...
function PremiumFeatures() {
   return (
      <section className="overflow-hidden">
         <div className="container 2xl:mb-32 xl:mb-24 lg:mb-16 md:mb-12 mb-8">
            <div className="max-w-[1700px] mx-auto">
               <div className="flex lg:flex-row flex-col justify-between lg:items-end mb-16">
                  ...
                  >
                     Enjoy the exclusive features that make building your web
                     pages a joyful moment. All in one theme!
                  </p>
               </div>
