         ...
         <div className="max-w-[1700px] mx-auto 2xl:mb-44 xl:mb-36 lg:mb-28 md:mb-20 mb-16">
            <div className="grid xl:grid-cols-2 gap-6 md:gap-9 lg:gap-12 xl:gap-0 relative z-0 px-4 xl:px-0">
               ...
               <div className="xl:pl-[8%] xl:mt-10">
                  <h2 className="text-xl sm:text-3xl md:text-6xl lg:text-7xl xl:text-8xl 3xl:text-10xl leading-[1.2] tracking-normal text-white font-medium mb-6">
                     Buy Kalles to{" "}
                  ...
                  <p className="lg:mb-14 md:mb-10 mb-6 lg:max-w-[650px] text-md md:text-base">
                  ...
                  <div className="bg-gray-black border border-transparent rounded-2xl xl:max-w-[455px] inline-block">
               ...
               <div className="">
                  <div className="relative">
                     <div className="absolute top-[50%] 2xl:-left-[14%] sm:-left-[18%] -left-[30%]">
                        <img src="/images/orange-arrow.svg" alt="" />
                     </div>
