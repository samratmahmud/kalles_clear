   ...
   return (
      <section className="2xl:mb-[200px] xl:mb-40 lg:mb-32 md:mb-20 sm:mb-16 mb-12">
         <div className="relative z-0 2xl:mb-32 xl:mb-24 lg:mb-20 md:mb-16 sm:mb-12 mb-8">
            ...
            <h2
               data-aos="fade-up"
               className="text-3xl sm:text-6xl md:text-12xl lg:text-16xl xl:text-22xl 2xl:text-17xl leading-[1.2] text-center font-medium text-lenear bg-Advanced xl:px-12 lg:px-8 px-4"
            >
               Advanced Mega Menu
            </h2>
            <div
