...
function PackageBuilt() {
   ...
   return (
      <section>
         <div className="container 2xl:mb-40 xl:mb-32 lg:mb-24 md:mb-20 mb-16">
            <div className="flex flex-col items-center justify-center mb-7 md:mb-10 lg:mb-12 xl:mb-16">
               <h3 className="2xl:text-5xl lg:text-3xl md:text-xl text-md font-medium text-lenear bg-one-stop text-center mb-3">
                  Save $2369 per year
               </h3>
               <h2 className="text-5xl sm:text-8xl md:text-10xl lg:text-12xl xl:text-13xl 2xl:text-16xl font-medium !tracking-[-2.4px] text-center text-white">
                  with Kalles built-in features
               </h2>
            </div>
            <div className="bg-features-build rounded-t-3xl w-full border-t border-x-2 border-transparent lg:mb-8 md:mb-8 mb-4 relative ">
