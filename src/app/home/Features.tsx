         ...
         <div id="features" className="container">
            <div className="max-w-[1700px] mx-auto mb-16 md:mb-20 lg:mb-28 xl:mb-40 2xl:mb-[200px]">
               ...
               <div className="grid grid-cols-12 gap-7">
                  <div
                     data-aos="fade-up"
                     className="col-span-12 md:col-span-6 xl:col-span-5 relative md:min-h-[380px]"
                  >
                     <img
                        className="w-full"
                  ...
                  <div
                     data-aos="fade-up"
                     data-aos-delay="200"
                     className="col-span-12 md:col-span-6 xl:col-span-7 relative min-h-[300px]"
                  >
                     <img
                        className="w-full"
                  ...
                  <div className="md:col-span-6 col-span-12 relative">
                     ...
                     <div className="absolute lg:bottom-10 md:bottom-6 bottom-3 lg:left-10 left-3 w-full">
                        <h2 className="2xl:text-3xl md:text-lg text-md font-medium text-white mb-4">
                           Video Thumbnail & 3D
                        </h2>
                        <p className="2xl:text-[16px] md:text-[14px] text-sm leading-[1.2] tracking-normal 2xl:max-w-[460px] lg:max-w-[400px] md:max-w-[320px] max-w-[320px]">
                  ...
                  <div className="md:col-span-6 col-span-12 relative">
                     ...
                     <div className="absolute top-12 sm:top-14 xl:top-20 2xl:top-24 xl:left-14 left-7 w-full">
                        <h3 className="text-base sm:text-xl md:text-2xl lg:text-4xl xl:text-5xl 2xl:text-8xl leading-tight font-medium text-white max-w-[125px] sm:max-w-[145px] md:max-w-[160px] lg:max-w-[212px] xl:max-w-[230px] 2xl:max-w-[290px]">
                           Increase
                  ...
                  <div className="xl:col-span-7 md:col-span-6 col-span-12 relative min-h-[300px]">
                     <img className="w-full" src="/images/item8.png" alt="" />
                     <div className="absolute xl:top-12 lg:top-6 bottom-4 px-2 w-full">
                        <h2 className="2xl:text-3xl md:text-lg text-md font-medium text-white mb-4 text-center">
                           Sticky Add To Cart
                        </h2>
                        <p className="2xl:text-[16px] md:text-[14px] text-sm leading-[1.2] tracking-normal 2xl:max-w-[360px] md:max-w-[280px] max-w-[250px] mx-auto text-center">
                           Persistent add-to-cart bar for easy and quick product
                           purchase
                        </p>
                     </div>
                  </div>
                  <div className="xl:col-span-5 md:col-span-6 col-span-12 relative">
                     ...
                     <div className="absolute lg:top-12 top-5 px-2 w-full">
                        ...
                        <p className="2xl:text-[16px] text-[14px] leading-[1.2] tracking-normal text-center">
