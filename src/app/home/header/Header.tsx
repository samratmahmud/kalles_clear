      ...
      <div className="container-width">
        <div className="flex gap-12 justify-between mb-36">
          <div className="w-[40%] mt-14">
            ...
            <p className="mb-7">
              Craft a beautiful and high-converting Shopify store with <br />
              Kalles multipurpose theme. Optimized for eCommerce, speed <br />{" "}
            ...
            <div className="flex gap-6 mb-4">
              ...
              <Buttons
                varient="outlined"
                href="/"
                icon="/images/icons8-bag-90.png"
                name="Open Store Free"
              />
            </div>
            <p className="text-md">
              Get 3 months trial Shopify with 1$/month, exclusive Shopify deal
              <br />
